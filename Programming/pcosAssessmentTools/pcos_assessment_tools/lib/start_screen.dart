    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              '⚠️ Important:',
                              style: GoogleFonts.arimo(fontSize: 19, height: 1.6, color: HexColor.fromHex('#1D192B'), fontStyle: FontStyle.italic, fontWeight: FontWeight.bold),
                            ),
                            ...
                            Text(
                              ...
                              style: GoogleFonts.arimo(fontSize: 17, height: 1.6, color: HexColor.fromHex('#1D192B'), fontStyle: FontStyle.italic, fontWeight: FontWeight.bold),
                            ),
                          ],
                        ),
                      ),
          ...
          // Floating button with shield image at bottom left
          Positioned(
            bottom: 16,
            right: 16,
            child: ElTooltip(
