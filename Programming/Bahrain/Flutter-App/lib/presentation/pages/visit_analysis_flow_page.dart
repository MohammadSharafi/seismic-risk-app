...
class _VisitAnalysisFlowPageState extends State<VisitAnalysisFlowPage> {
  ...
  // Medication handlers
  void _handleEditMedication(Medication medication) {
    setState(() {
      _editingMedicationId = medication.id;
  ...
  // Procedure handlers
  void _handleEditProcedure(Procedure procedure) {
    setState(() {
      _editingProcedureId = procedure.id;
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const Text(
              ...
              style: TextStyle(
                fontSize:
                    TailwindFontSize.textBase, // font-semibold text-gray-900
                fontWeight: FontWeight.w600,
                color: AppTheme.gray900,
                height: 1.5,
                letterSpacing: 0,
        ...
        const Text(
          ...
          style: TextStyle(
            fontSize: TailwindFontSize.textSm, // text-sm text-gray-600
            color: AppTheme.gray600,
            height: 1.5,
            letterSpacing: 0,
          ),
        ...
        // AI Proposed Plan Section (FIRST - this was missing!)
        Container(
          padding: const EdgeInsets.all(TailwindSpacing.p4), // p-4
          decoration: BoxDecoration(
            color: AppTheme.purple50, // bg-purple-50
            border: Border.all(color: AppTheme.purple200), // border-purple-200
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  SvgIcons.brain(
                      size: 16, color: AppTheme.purple600), // w-4 h-4
                  const SizedBox(width: 8), // gap-2
                  const Text(
                    'AI Proposed Plan (Editable)',
                    style: TextStyle(
                      fontSize: TailwindFontSize.textSm, // text-sm
                      fontWeight: FontWeight.w600, // font-semibold
                      color: AppTheme.gray900,
              ...
              const Text(
                'Proposed actions generated by AI agents. Review and adjust based on clinical judgment.',
                style: TextStyle(
                  fontSize: TailwindFontSize.textXs, // text-xs
                  color: AppTheme.gray600,
                  height: 1.5,
              ...
              const SizedBox(height: 16), // mb-4
              const Text(
                'Proposed plan is assistive; clinician review is required.',
                style: TextStyle(
                  fontSize: TailwindFontSize.textXs, // text-xs
                  fontStyle: FontStyle.italic,
        ...
        const SizedBox(height: 24), // space-y-6 (gap between sections)

        // Two-column layout: AI Context (left) + Your Decision (right)
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            // Left: AI Context
            Expanded(
              child: Column(
                children: [
                  Container(
                    padding: const EdgeInsets.all(
                        TailwindSpacing.p2), // p-2 (further reduced)
                    decoration: BoxDecoration(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildContributingFactor(
                          SvgIcons.trendingUp(
                              size: 12, color: AppTheme.blue600),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            SvgIcons.user(size: 16, color: AppTheme.blue600),
                            const SizedBox(width: 8),
                            const Text(
                              'Your Decision',
                              style: TextStyle(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _discussionReferenced
                            ? TextButton.icon(
                                onPressed: () {
                                  // Navigate to clinical discussion
                                },
                                icon: SvgIcons.externalLink(
                                    size: 12,
                                    color: AppTheme.blue600), // w-3 h-3
                                label: const Text(
                                  'Clinical discussion referenced in this decision',
                                  style: TextStyle(
                                    fontSize: TailwindFontSize.textSm,
  ...
  Widget _buildContributingFactor(Widget icon, String title, String subtitle) {
    return InkWell(
      onTap: () {},
      child: Container(
        padding: const EdgeInsets.all(TailwindSpacing.p2),
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            icon, // Already sized and colored
            const SizedBox(width: 8),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
  ...
  // Helper method to build Medications section in AI Proposed Plan
  Widget _buildMedicationsSection() {
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            SvgIcons.alertCircle(size: 12, color: AppTheme.gray600), // w-3 h-3
            const SizedBox(width: 4), // gap-1
            const Text(
              'Hover to view evidence details',
              style: TextStyle(
                fontSize: TailwindFontSize.textXs, // text-xs
                color: AppTheme.gray600,
                height: 1.5,
        ...
        ...List.generate(
          ...
          (index) {
            ...
            final isEditing = _editingMedicationId == medication.id;
            return Padding(
              ...
              child: MedicationCard(
                ...
                onDelete: () => _handleDeleteMedication(medication.id),
                onSave: _handleSaveMedication,
                onCancel: _handleCancelMedicationEdit,
              ),
            );
          },
        ),
        // Add new medication form
        if (_addingMedication)
          Container(
            ...
            child: _buildAddMedicationForm(),
          ),
        // Add medication button
        if (!_addingMedication)
          TextButton.icon(
            onPressed: _handleAddMedication,
            icon: SvgIcons.plus(size: 16, color: AppTheme.blue600), // w-4 h-4
            label: const Text(
  ...
  // Helper method to build Procedures section in AI Proposed Plan
      ...
      children: [
        ...
        ...List.generate(
          ...
          (index) {
            ...
            final isEditing = _editingProcedureId == procedure.id;
            return Padding(
              padding: const EdgeInsets.only(bottom: 12), // space-y-3
              child: ProcedureCard(
                procedure: procedure,
                isEditing: isEditing,
                onEdit: () => _handleEditProcedure(procedure),
                onDelete: () => _handleDeleteProcedure(procedure.id),
                onSave: _handleSaveProcedure,
                onCancel: _handleCancelProcedureEdit,
              ),
            );
          },
        ),
        ...
        if (_addingProcedure)
          Container(
            ...
            child: _buildAddProcedureForm(),
          ),
        // Add procedure button
        if (!_addingProcedure)
          TextButton.icon(
            onPressed: _handleAddProcedure,
            icon: SvgIcons.plus(size: 16, color: AppTheme.blue600), // w-4 h-4
            label: const Text(
  ...
  // Helper method to build Add Medication form
  Widget _buildAddMedicationForm() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
          'Add a new recommendation based on your clinical judgment.',
          style: TextStyle(
            fontSize: TailwindFontSize.textXs,
        ...
        MedicationCard(
          ...
          onEdit: () {},
          onDelete: () {},
          onSave: _handleSaveNewMedication,
          onCancel: _handleCancelMedicationEdit,
        ),
      ],
    );
  ...
  // Helper method to build Add Procedure form
  Widget _buildAddProcedureForm() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
        ...
        ProcedureCard(
          ...
          onEdit: () {},
          onDelete: () {},
          onSave: _handleSaveNewProcedure,
          onCancel: _handleCancelProcedureEdit,
        ),
      ],
    );
