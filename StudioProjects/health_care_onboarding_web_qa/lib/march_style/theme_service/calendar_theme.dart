...
/// Applies a theme to descendant Syncfusion calendar screens.
///
/// ```dart
...
class SfCalendarTheme extends InheritedTheme {
  ...
  /// descendant Syncfusion calendar screens.
  const SfCalendarTheme({Key? key, required this.data, required this.child})
      : super(key: key, child: child);

  /// Specifies the color and typography values for descendant calendar screens.
  ///
  /// ```dart
  /// Widget build(BuildContext context) {
  ///   return Scaffold(
...
class SfCalendarThemeData with Diagnosticable {
  ...
  /// Specifies the background color of calendar screens.
  ///
  /// ```dart
  /// Widget build(BuildContext context) {
  ///  return Scaffold(
  ...
  ///Specifies the cell border color of calendar screens.
  ///
  /// ```dart
  /// Widget build(BuildContext context) {
  ///  return Scaffold(
  ...
  ///Specifies the current month text style color of calendar screens.
  ///
  /// ```dart
  /// Widget build(BuildContext context) {
  ///  return Scaffold(
