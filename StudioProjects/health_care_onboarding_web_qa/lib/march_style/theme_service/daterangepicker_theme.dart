...
/// Applies a theme to descendant Syncfusion date range picker screens.
///
/// ```dart
...
class SfDateRangePickerTheme extends InheritedTheme {
  ...
  /// descendant Syncfusion date range picker screens.
  const SfDateRangePickerTheme(
      {Key? key, required this.data, required this.child})
      : super(key: key, child: child);

  /// Specifies the color and typography values for descendant chart screens.
  ///
  /// ```dart
  /// Widget build(BuildContext context) {
  ///  return Scaffold(
...
class SfDateRangePickerThemeData with Diagnosticable {
  ...
  /// date range picker screens will be applied.
  ///
