...
class ThemeController with ChangeNotifier {
  ...
  Future<void> setCustomScheme(FlexSchemeData scheme) async {
    ...
    await setPrimaryVariantLight(scheme.light.primary, false);
    await setSecondaryLight(scheme.light.secondary, false);
    await setSecondaryVariantLight(scheme.light.secondary, false);
    await setPrimaryDark(scheme.dark.primary, false);
    await setPrimaryVariantDark(scheme.dark.primary, false);
    await setSecondaryDark(scheme.dark.secondary, false);
    await setSecondaryVariantDark(scheme.dark.secondary, false);
