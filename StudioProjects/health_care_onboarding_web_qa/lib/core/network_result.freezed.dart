...
abstract class _Success<T, E extends Exception> implements NetworkResult<T, E> {
...
abstract class _Failure<T, E extends Exception> implements NetworkResult<T, E> {
