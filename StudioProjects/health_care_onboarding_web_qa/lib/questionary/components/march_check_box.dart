...
class MarchCheckBox extends StatefulWidget {
  ...
  @override
  _MarchCheckBoxState createState() => _MarchCheckBoxState();
}

class _MarchCheckBoxState extends State<MarchCheckBox> {
  late bool _checked;
  ...
  @override
  void didUpdateWidget(MarchCheckBox oldWidget) {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      ...
      padding: const EdgeInsets.only(top: 1, bottom: 1, right: 4),
