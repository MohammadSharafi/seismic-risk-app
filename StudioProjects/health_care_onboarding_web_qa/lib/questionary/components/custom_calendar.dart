...
class PeriodDateSelector extends StatefulWidget {
  const PeriodDateSelector({super.key, required this.onSelect, required this.selectedDate});
  final DateTime selectedDate;

  final Function(DateTime a) onSelect;
  @override
  _PeriodDateSelectorState createState() => _PeriodDateSelectorState(selectedDate: selectedDate);
}

class _PeriodDateSelectorState extends State<PeriodDateSelector> {
  late DateTime _currentDate;
   DateTime selectedDate;
   _PeriodDateSelectorState({required this.selectedDate});
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: selectedDate.day == day && selectedDate.month == _currentDate.month
              ...
              child: Text(
                ...
                style: TextStyle(
                  color: isFutureDate
                      ...
                      : (selectedDate.day == day && selectedDate.month == _currentDate.month
                      ? Colors.white
                      : Colors.black),
